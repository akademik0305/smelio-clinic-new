				...
				<div class="mt-4">
					...
					>
						<div
							...
							:key="item.id"
							class="bg-white p-4 rounded-md shadow-sm hover:scale-[1.02] hover:shadow-md transition-all duration-500"
						>
							<NuxtLink
								:to="localePath(`/employees/${item.id}`)"
								class="flex flex-col sm:flex-row items-center gap-5"
							>
								<div
									class="w-32 h-32 sm:w-40 sm:h-40 rounded-xl overflow-hidden shrink-0"
								>
									<img
										:src="item.imageUrl"
